...
- **Pipeline:** Generate body PDF via Tectonic (no title page in `.tex`) → Generate cover HTML (Template 03/04/06) → Playwright `page.pdf()` → Merge cover as page 0 via pypdf
...
4. Write cover HTML using Template 03/04/06 from typesetting/cover.md (Template 06 for thesis proposals/dissertations)
