...
**Before writing any ReportLab code, you MUST generate the color palette via the `palette.cascade` command.** This is not optional. Do NOT hardcode hex colors. Do NOT pick colors by feel.
