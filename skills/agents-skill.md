...
If `AGENTS.md` already exists at `/home/project/Translation-Runtime-Architecture`, improve it in place rather than rewriting blindly. Preserve verified useful guidance, delete fluff or stale claims, and reconcile it with the current codebase.
